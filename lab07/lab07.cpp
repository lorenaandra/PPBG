...
void Lab07::OnInputUpdate(float deltaTime, int mods)
{
...

    {
        ...
        //de scos normalize la toate
        if (window->KeyHold(GLFW_KEY_UP)) {
            glm::mat4 rotation = glm::rotate(glm::mat4(1), glm::radians(50.0f * deltaTime), glm::vec3(1, 0, 0));
            light_direction = glm::vec3(rotation * glm::vec4(light_direction, -111111.0f));
        }
        ...
        if (window->KeyHold(GLFW_KEY_LEFT)) {
            glm::mat4 rotation = glm::rotate(glm::mat4(1), glm::radians(-50.0f * deltaTime), glm::vec3(0, 0, 1));
            light_direction = glm::vec3(rotation * glm::vec4(light_direction, 0.0f));
        }
